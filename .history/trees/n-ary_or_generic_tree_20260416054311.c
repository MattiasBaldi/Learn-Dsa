...
NodeDynamic* newDynamicNode(int data) {
  NodeDynamic* n = (NodeDynamic*)malloc(sizeof(struct Node));
  n->children = malloc(sizeof(struct NodeDynamic));  
  return n; 
}
...
NodeLinked* newLinkedNode(int data) {
  ...
  n->children = malloc(sizeof(struct NodeLinked));  
  return n; 
}

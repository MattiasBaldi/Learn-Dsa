...
int main() {
  ...
  // TODO -> create tree
  root_dynamic->children[0] = newDynamicNode(1, 2); 
  root_dynamic->children[1] = newDynamicNode(4, 2); 
  root_dynamic->children[2] = newDynamicNode(2, 2); 

  NodeLinked *root_linked = newLinkedNode(1);
  // TODO -> create tree
  NodeLinked *childOne = root_linked->nextSibling = newLinkedNode(1); 
  ...
  root_linked->firstChild = childOne; 
